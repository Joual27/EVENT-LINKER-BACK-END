...
public interface MessageMapper extends BaseCreateMapper<Message , SendMessageDTO> , BaseResponseMapper<Message , MessageResponseDTO> , BaseEmbeddedMapper<Message , EmbeddedMessageDTO> {
    @Override
