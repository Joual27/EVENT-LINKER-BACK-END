    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/v1/DMs").hasAnyRole("ORGANIZER", "WORKER")
                        .requestMatchers("/api/v1/reviews").hasAnyRole("ORGANIZER", "WORKER")
                        .requestMatchers("/api/v1/skills").hasAnyRole("ORGANIZER", "WORKER")
                        .requestMatchers("/api/v1/users/**").hasAnyRole("ORGANIZER", "WORKER")
